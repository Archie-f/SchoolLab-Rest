...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionWrapper> handleNotFoundException(NotFoundException exception, HttpServletRequest request){
        //create a json with ExceptionWrapper and return body wit 404 status code
